...
class TreeNode {
  ...
  // Add any helper functions you may need here
	...
	static Node savePtr = null;
	static HashMap<Integer, Integer> map = new HashMap<Integer, Integer>();
  
  public static int charCount(Node node, String str, char ch, int val) {
	...
	public static void search(Node node, int val) {
  ...
  int[] countOfNodes(Node root, ArrayList<Query> queries, String s) {
    ...
    savePtr =null;
		...
		for(Query query: queries) {
			...
			int count =0;
			if(parent != null) {
				charCount(parent, s, query.c, parent.val);
				result[k++] = map.get(parent.val);
			}
		}
